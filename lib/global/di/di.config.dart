...
import 'package:bunny_sync/features/add_breeder/repo/add_breeder_repo.dart'
    as _i5;
import 'package:bunny_sync/features/add_cage/cubit/add_cage_cubit.dart' as _i40;
...
import 'package:bunny_sync/features/add_litter/repo/add_litter_repo.dart'
    as _i10;
import 'package:bunny_sync/features/add_note/cubit/add_note_cubit.dart' as _i45;
import 'package:bunny_sync/features/add_note/repo/add_note_repo.dart' as _i11;
import 'package:bunny_sync/features/add_task/cubit/add_task_cubit.dart' as _i46;
...
import 'package:bunny_sync/features/breeder_details/repo/breeder_details_repo.dart'
    as _i14;
import 'package:bunny_sync/features/breeders/cubit/breeders_cubit.dart' as _i52;
...
import 'package:bunny_sync/features/dashboard/cubit/dashboard_cubit.dart'
    as _i19;
import 'package:bunny_sync/features/health/cubit/health_cubit.dart' as _i57;
import 'package:bunny_sync/features/health/repo/health_repo.dart' as _i22;
import 'package:bunny_sync/features/home/cubit/home_cubit.dart' as _i58;
import 'package:bunny_sync/features/home/repo/repo/home_repo.dart' as _i23;
import 'package:bunny_sync/features/ledger/cubit/ledgers_cubit.dart' as _i59;
...
import 'package:bunny_sync/features/litter_details/repo/litter_details_repo.dart'
    as _i26;
import 'package:bunny_sync/features/litters/cubit/litters_cubit.dart' as _i61;
...
import 'package:bunny_sync/features/main_navigation/cubit/main_navigation_cubit.dart'
    as _i29;
import 'package:bunny_sync/features/profile/cubit/profile_cubit.dart' as _i62;
import 'package:bunny_sync/features/profile/repo/profile_repo.dart' as _i31;
import 'package:bunny_sync/features/sign_in/cubit/sign_in_cubit.dart' as _i64;
import 'package:bunny_sync/features/sign_in/repo/sign_in_repo.dart' as _i33;
import 'package:bunny_sync/features/tasks/cubit/tasks_cubit.dart' as _i65;
import 'package:bunny_sync/features/tasks/repo/tasks_repo.dart' as _i34;
...
import 'package:bunny_sync/global/blocs/upload_file_cubit/upload_file_cubit.dart'
    as _i35;
import 'package:bunny_sync/global/di/modules/app_module.dart' as _i66;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    await gh.singletonAsync<_i36.UserRepo>(
      () {
        final i = _i36.UserRepo();
        return i.init().then((_) => i);
      },
      preResolve: true,
    );
    ...
    gh.factory<_i37.AddAilmentCubit>(
        () => _i37.AddAilmentCubit(gh<_i3.AddAilmentRepo>()));
    gh.factory<_i38.AddAttachmentCubit>(
        () => _i38.AddAttachmentCubit(gh<_i4.AddAttachmentRepo>()));
    gh.factory<_i39.AddBreederCubit>(
        () => _i39.AddBreederCubit(gh<_i5.AddBreederRepo>()));
    gh.factory<_i40.AddCageCubit>(
        () => _i40.AddCageCubit(gh<_i6.AddCageRepo>()));
    gh.factory<_i41.AddCategoryCubit>(
        () => _i41.AddCategoryCubit(gh<_i7.AddCategoryRepo>()));
    gh.factory<_i42.AddCustomerCubit>(
        () => _i42.AddCustomerCubit(gh<_i8.AddCustomerRepo>()));
    gh.factory<_i43.AddLedgerCubit>(
        () => _i43.AddLedgerCubit(gh<_i9.AddLedgerRepo>()));
    gh.factory<_i44.AddLitterCubit>(
        () => _i44.AddLitterCubit(gh<_i10.AddLitterRepo>()));
    gh.factory<_i45.AddNoteCubit>(
        () => _i45.AddNoteCubit(gh<_i11.AddNoteRepo>()));
    gh.factory<_i46.AddTaskCubit>(
        () => _i46.AddTaskCubit(gh<_i12.AddTaskRepo>()));
    gh.factory<_i47.AddTreatmentCubit>(
        () => _i47.AddTreatmentCubit(gh<_i13.AddTreatmentRepo>()));
    gh.singleton<_i48.AuthenticationBloc>(
        () => _i48.AuthenticationBloc(gh<_i49.UserRepo>()));
    gh.factoryParam<_i50.BreederDetailsCubit, _i51.BreederEntryModel, dynamic>((
      breeder,
      _,
    ) =>
        _i50.BreederDetailsCubit(
          gh<_i14.BreederDetailsRepo>(),
          breeder,
        ));
    gh.factory<_i52.BreedersCubit>(
        () => _i52.BreedersCubit(gh<_i15.BreedersRepo>()));
    gh.factory<_i53.CageCardsCubit>(
        () => _i53.CageCardsCubit(gh<_i16.CageCardsRepo>()));
    gh.factory<_i54.CategoriesCubit>(
        () => _i54.CategoriesCubit(gh<_i17.CategoriesRepo>()));
    gh.factory<_i55.CustomersCubit>(
        () => _i55.CustomersCubit(gh<_i18.CustomersRepo>()));
    gh.factory<_i56.DeleteBreederCubit>(
        () => _i56.DeleteBreederCubit(gh<_i20.DeleteBreederRepo>()));
    gh.factory<_i57.HealthCubit>(() => _i57.HealthCubit(gh<_i22.HealthRepo>()));
    gh.factory<_i58.HomeCubit>(() => _i58.HomeCubit(gh<_i23.HomeRepo>()));
    gh.factory<_i59.LedgersCubit>(
        () => _i59.LedgersCubit(gh<_i25.LedgersRepo>()));
    gh.factory<_i60.LitterDetailsCubit>(
        () => _i60.LitterDetailsCubit(gh<_i26.LitterDetailsRepo>()));
    gh.factory<_i61.LittersCubit>(
    ...
    gh.factory<_i65.TasksCubit>(() => _i65.TasksCubit(gh<_i34.TasksRepo>()));
    return this;
  }
}
