...
import 'package:bunny_sync/features/add_litter/repo/add_litter_repo.dart'
    as _i4;
import 'package:bunny_sync/features/add_note/cubit/add_note_cubit.dart' as _i22;
...
import 'package:bunny_sync/features/breeder_details/repo/breeder_details_repo.dart'
    as _i6;
import 'package:bunny_sync/features/breeders/cubit/breeders_cubit.dart' as _i27;
...
import 'package:bunny_sync/features/litter_details/repo/litter_details_repo.dart'
    as _i12;
import 'package:bunny_sync/features/litters/cubit/litters_cubit.dart' as _i30;
...
import 'package:bunny_sync/features/main_navigation/cubit/main_navigation_cubit.dart'
    as _i15;
import 'package:bunny_sync/features/sign_in/cubit/sign_in_cubit.dart' as _i31;
import 'package:bunny_sync/features/sign_in/repo/sign_in_repo.dart' as _i17;
import 'package:bunny_sync/features/tasks/cubit/tasks_cubit.dart' as _i32;
import 'package:bunny_sync/features/tasks/repo/tasks_repo.dart' as _i18;
...
import 'package:bunny_sync/global/blocs/permissions_cubit/permissions_cubit.dart'
    as _i16;
import 'package:bunny_sync/global/di/modules/app_module.dart' as _i33;
...
import 'package:bunny_sync/global/repos/delete_breeder_repo/delete_breeder_repo.dart'
    as _i9;
import 'package:bunny_sync/global/repos/repos.dart' as _i24;
import 'package:bunny_sync/global/repos/user_repo.dart' as _i19;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i18.TasksRepo>(() => _i18.HttpTasksRepo());
    await gh.singletonAsync<_i19.UserRepo>(
      () {
        final i = _i19.UserRepo();
        return i.init().then((_) => i);
      },
      preResolve: true,
    );
    ...
    gh.factory<_i20.AddBreederCubit>(
        () => _i20.AddBreederCubit(gh<_i3.AddBreederRepo>()));
    gh.factory<_i21.AddLitterCubit>(
        () => _i21.AddLitterCubit(gh<_i4.AddLitterRepo>()));
    gh.factory<_i22.AddNoteCubit>(
        () => _i22.AddNoteCubit(gh<_i5.AddNoteRepo>()));
    gh.singleton<_i23.AuthenticationBloc>(
        () => _i23.AuthenticationBloc(gh<_i24.UserRepo>()));
    gh.factoryParam<_i25.BreederDetailsCubit, _i26.BreederEntryModel, dynamic>((
      breeder,
      _,
    ) =>
        _i25.BreederDetailsCubit(
          gh<_i6.BreederDetailsRepo>(),
          breeder,
        ));
    gh.factory<_i27.BreedersCubit>(
        () => _i27.BreedersCubit(gh<_i7.BreedersRepo>()));
    gh.factory<_i28.DeleteBreederCubit>(
        () => _i28.DeleteBreederCubit(gh<_i9.DeleteBreederRepo>()));
    gh.factory<_i29.LitterDetailsCubit>(
        () => _i29.LitterDetailsCubit(gh<_i12.LitterDetailsRepo>()));
    gh.factory<_i30.LittersCubit>(
        () => _i30.LittersCubit(gh<_i13.LittersRepo>()));
    gh.factory<_i31.SignInCubit>(() => _i31.SignInCubit(
          gh<_i17.SignInRepo>(),
          gh<_i23.AuthenticationBloc>(),
        ));
    gh.factory<_i32.TasksCubit>(() => _i32.TasksCubit(gh<_i18.TasksRepo>()));
    return this;
  }
}
