...
import 'package:bunny_sync/features/litter_details/repo/litter_details_repo.dart'
    as _i25;
import 'package:bunny_sync/features/litters/cubit/litters_cubit.dart' as _i58;
...
import 'package:bunny_sync/features/main_navigation/cubit/main_navigation_cubit.dart'
    as _i28;
import 'package:bunny_sync/features/profile/cubit/profile_cubit.dart' as _i59;
import 'package:bunny_sync/features/profile/repo/profile_repo.dart' as _i30;
import 'package:bunny_sync/features/sign_in/cubit/sign_in_cubit.dart' as _i60;
import 'package:bunny_sync/features/sign_in/repo/sign_in_repo.dart' as _i31;
import 'package:bunny_sync/features/tasks/cubit/tasks_cubit.dart' as _i61;
...
import 'package:bunny_sync/global/blocs/upload_file_cubit/upload_file_cubit.dart'
    as _i33;
import 'package:bunny_sync/global/di/modules/app_module.dart' as _i62;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i57.LitterDetailsCubit>(
        () => _i57.LitterDetailsCubit(gh<_i25.LitterDetailsRepo>()));
    gh.factory<_i58.LittersCubit>(
        () => _i58.LittersCubit(gh<_i26.LittersRepo>()));
    gh.factory<_i59.ProfileCubit>(
        () => _i59.ProfileCubit(gh<_i30.ProfileRepo>()));
    gh.factory<_i60.SignInCubit>(() => _i60.SignInCubit(
          gh<_i31.SignInRepo>(),
          gh<_i45.AuthenticationBloc>(),
        ));
    gh.factory<_i61.TasksCubit>(() => _i61.TasksCubit(gh<_i32.TasksRepo>()));
    return this;
  }
}
