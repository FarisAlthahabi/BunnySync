...
import 'package:bunny_sync/features/add_litter/repo/add_litter_repo.dart'
    as _i8;
import 'package:bunny_sync/features/add_note/cubit/add_note_cubit.dart' as _i37;
import 'package:bunny_sync/features/add_note/repo/add_note_repo.dart' as _i9;
import 'package:bunny_sync/features/add_task/cubit/add_task_cubit.dart' as _i38;
...
import 'package:bunny_sync/features/breeder_details/repo/breeder_details_repo.dart'
    as _i12;
import 'package:bunny_sync/features/breeders/cubit/breeders_cubit.dart' as _i44;
...
import 'package:bunny_sync/features/dashboard/cubit/dashboard_cubit.dart'
    as _i16;
import 'package:bunny_sync/features/health/cubit/health_cubit.dart' as _i48;
import 'package:bunny_sync/features/health/repo/health_repo.dart' as _i19;
import 'package:bunny_sync/features/home/cubit/home_cubit.dart' as _i49;
...
import 'package:bunny_sync/features/litter_details/repo/litter_details_repo.dart'
    as _i22;
import 'package:bunny_sync/features/litters/cubit/litters_cubit.dart' as _i51;
import 'package:bunny_sync/features/litters/repo/litters_repo.dart' as _i23;
import 'package:bunny_sync/features/main_navigation/cubit/main_navigation_cubit.dart'
    as _i25;
import 'package:bunny_sync/features/profile/cubit/profile_cubit.dart' as _i52;
import 'package:bunny_sync/features/profile/repo/profile_repo.dart' as _i27;
import 'package:bunny_sync/features/sign_in/cubit/sign_in_cubit.dart' as _i53;
import 'package:bunny_sync/features/sign_in/repo/sign_in_repo.dart' as _i28;
import 'package:bunny_sync/features/tasks/cubit/tasks_cubit.dart' as _i54;
import 'package:bunny_sync/features/tasks/repo/tasks_repo.dart' as _i29;
...
import 'package:bunny_sync/global/blocs/permissions_cubit/permissions_cubit.dart'
    as _i26;
import 'package:bunny_sync/global/di/modules/app_module.dart' as _i55;
...
import 'package:bunny_sync/global/repos/delete_breeder_repo/delete_breeder_repo.dart'
    as _i17;
import 'package:bunny_sync/global/repos/repos.dart' as _i41;
import 'package:bunny_sync/global/repos/user_repo.dart' as _i30;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i22.LitterDetailsRepo>(() => _i22.HttpLitterDetailsRepo());
    gh.factory<_i23.LittersRepo>(() => _i23.HttpLittersRepo());
    gh.factory<_i24.LocalizationCubit>(() => _i24.LocalizationCubit());
    gh.factory<_i25.MainNavigationCubit>(() => _i25.MainNavigationCubit());
    gh.factory<_i26.PermissionsCubit>(() => _i26.PermissionsCubit());
    gh.factory<_i27.ProfileRepo>(() => _i27.HttpProfileRepo());
    gh.factory<_i28.SignInRepo>(() => _i28.HttpSignInRepo());
    gh.factory<_i29.TasksRepo>(() => _i29.HttpTasksRepo());
    await gh.singletonAsync<_i30.UserRepo>(
      () {
        final i = _i30.UserRepo();
        return i.init().then((_) => i);
      },
      preResolve: true,
    );
    ...
    gh.factory<_i31.AddAilmentCubit>(
        () => _i31.AddAilmentCubit(gh<_i3.AddAilmentRepo>()));
    gh.factory<_i32.AddBreederCubit>(
        () => _i32.AddBreederCubit(gh<_i4.AddBreederRepo>()));
    gh.factory<_i33.AddCategoryCubit>(
        () => _i33.AddCategoryCubit(gh<_i5.AddCategoryRepo>()));
    gh.factory<_i34.AddCustomerCubit>(
        () => _i34.AddCustomerCubit(gh<_i6.AddCustomerRepo>()));
    gh.factory<_i35.AddLedgerCubit>(
        () => _i35.AddLedgerCubit(gh<_i7.AddLedgerRepo>()));
    gh.factory<_i36.AddLitterCubit>(
        () => _i36.AddLitterCubit(gh<_i8.AddLitterRepo>()));
    gh.factory<_i37.AddNoteCubit>(
        () => _i37.AddNoteCubit(gh<_i9.AddNoteRepo>()));
    gh.factory<_i38.AddTaskCubit>(
        () => _i38.AddTaskCubit(gh<_i10.AddTaskRepo>()));
    gh.factory<_i39.AddTreatmentCubit>(
        () => _i39.AddTreatmentCubit(gh<_i11.AddTreatmentRepo>()));
    gh.singleton<_i40.AuthenticationBloc>(
        () => _i40.AuthenticationBloc(gh<_i41.UserRepo>()));
    gh.factoryParam<_i42.BreederDetailsCubit, _i43.BreederEntryModel, dynamic>((
      breeder,
      _,
    ) =>
        _i42.BreederDetailsCubit(
          gh<_i12.BreederDetailsRepo>(),
          breeder,
        ));
    gh.factory<_i44.BreedersCubit>(
        () => _i44.BreedersCubit(gh<_i13.BreedersRepo>()));
    gh.factory<_i45.CategoriesCubit>(
        () => _i45.CategoriesCubit(gh<_i14.CategoriesRepo>()));
    gh.factory<_i46.CustomersCubit>(
        () => _i46.CustomersCubit(gh<_i15.CustomersRepo>()));
    gh.factory<_i47.DeleteBreederCubit>(
        () => _i47.DeleteBreederCubit(gh<_i17.DeleteBreederRepo>()));
    gh.factory<_i48.HealthCubit>(() => _i48.HealthCubit(gh<_i19.HealthRepo>()));
    gh.factory<_i49.HomeCubit>(() => _i49.HomeCubit(gh<_i20.HomeRepo>()));
    gh.factory<_i50.LitterDetailsCubit>(
        () => _i50.LitterDetailsCubit(gh<_i22.LitterDetailsRepo>()));
    gh.factory<_i51.LittersCubit>(
        () => _i51.LittersCubit(gh<_i23.LittersRepo>()));
    gh.factory<_i52.ProfileCubit>(
        () => _i52.ProfileCubit(gh<_i27.ProfileRepo>()));
    gh.factory<_i53.SignInCubit>(() => _i53.SignInCubit(
          gh<_i28.SignInRepo>(),
          gh<_i40.AuthenticationBloc>(),
        ));
    gh.factory<_i54.TasksCubit>(() => _i54.TasksCubit(gh<_i29.TasksRepo>()));
    return this;
  }
}
