...
import 'package:bunny_sync/features/customers/cubit/customers_cubit.dart'
    as _i32;
import 'package:bunny_sync/features/customers/repo/customers_repo.dart' as _i10;
...
import 'package:bunny_sync/features/litter_details/repo/litter_details_repo.dart'
    as _i15;
import 'package:bunny_sync/features/litters/cubit/litters_cubit.dart' as _i35;
import 'package:bunny_sync/features/litters/repo/litters_repo.dart' as _i16;
...
import 'package:bunny_sync/global/dio/dio_client.dart' as _i13;
import 'package:bunny_sync/global/localization/cubit/localization_cubit.dart'
    as _i17;
import 'package:bunny_sync/global/localization/language_changer.dart' as _i14;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i9.CageCardsRepo>(() => _i9.HttpCageCardsRepo());
    gh.factory<_i10.CustomersRepo>(() => _i10.HttpCustomersRepo());
    gh.factory<_i11.DashboardCubit>(() => _i11.DashboardCubit());
    gh.factory<_i12.DeleteBreederRepo>(() => _i12.HttpDeleteBreederRepo());
    gh.singleton<_i13.DioClient>(() => _i13.DioClient());
    await gh.singletonAsync<_i14.LanguageChanger>(
      () {
        final i = _i14.LanguageChanger();
        return i.init().then((_) => i);
      },
      preResolve: true,
    );
    gh.factory<_i15.LitterDetailsRepo>(() => _i15.HttpLitterDetailsRepo());
    gh.factory<_i16.LittersRepo>(() => _i16.HttpLittersRepo());
    gh.factory<_i17.LocalizationCubit>(() => _i17.LocalizationCubit());
    gh.factory<_i18.MainNavigationCubit>(() => _i18.MainNavigationCubit());
    gh.factory<_i19.PermissionsCubit>(() => _i19.PermissionsCubit());
    ...
    gh.factory<_i23.AddCustomerCubit>(
        () => _i23.AddCustomerCubit(gh<_i4.AddCustomerRepo>()));
    ...
    gh.factory<_i31.CageCardsCubit>(
        () => _i31.CageCardsCubit(gh<_i9.CageCardsRepo>()));
    gh.factory<_i32.CustomersCubit>(
        () => _i32.CustomersCubit(gh<_i10.CustomersRepo>()));
    gh.factory<_i33.DeleteBreederCubit>(
        () => _i33.DeleteBreederCubit(gh<_i12.DeleteBreederRepo>()));
    gh.factory<_i34.LitterDetailsCubit>(
        () => _i34.LitterDetailsCubit(gh<_i15.LitterDetailsRepo>()));
    gh.factory<_i35.LittersCubit>(
        () => _i35.LittersCubit(gh<_i16.LittersRepo>()));
