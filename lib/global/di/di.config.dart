...
import 'package:bunny_sync/features/add_breeder/repo/add_breeder_repo.dart'
    as _i4;
import 'package:bunny_sync/features/add_cage/cubit/add_cage_cubit.dart' as _i34;
...
import 'package:bunny_sync/features/add_litter/repo/add_litter_repo.dart'
    as _i8;
import 'package:bunny_sync/features/add_note/cubit/add_note_cubit.dart' as _i38;
import 'package:bunny_sync/features/add_note/repo/add_note_repo.dart' as _i9;
import 'package:bunny_sync/features/add_task/cubit/add_task_cubit.dart' as _i39;
...
import 'package:bunny_sync/features/breeder_details/repo/breeder_details_repo.dart'
    as _i12;
import 'package:bunny_sync/features/breeders/cubit/breeders_cubit.dart' as _i45;
...
import 'package:bunny_sync/features/customers/cubit/customers_cubit.dart'
    as _i48;
import 'package:bunny_sync/features/customers/repo/customers_repo.dart' as _i16;
...
import 'package:bunny_sync/features/health/repo/health_repo.dart' as _i20;
import 'package:bunny_sync/features/home/cubit/home_cubit.dart' as _i51;
import 'package:bunny_sync/features/home/repo/repo/home_repo.dart' as _i21;
...
import 'package:bunny_sync/features/litter_details/repo/litter_details_repo.dart'
    as _i23;
import 'package:bunny_sync/features/litters/cubit/litters_cubit.dart' as _i53;
...
import 'package:bunny_sync/features/main_navigation/cubit/main_navigation_cubit.dart'
    as _i26;
import 'package:bunny_sync/features/profile/cubit/profile_cubit.dart' as _i54;
import 'package:bunny_sync/features/profile/repo/profile_repo.dart' as _i28;
import 'package:bunny_sync/features/sign_in/cubit/sign_in_cubit.dart' as _i55;
import 'package:bunny_sync/features/sign_in/repo/sign_in_repo.dart' as _i29;
import 'package:bunny_sync/features/tasks/cubit/tasks_cubit.dart' as _i56;
...
import 'package:bunny_sync/global/blocs/permissions_cubit/permissions_cubit.dart'
    as _i27;
import 'package:bunny_sync/global/di/modules/app_module.dart' as _i57;
import 'package:bunny_sync/global/dio/dio_client.dart' as _i19;
import 'package:bunny_sync/global/localization/cubit/localization_cubit.dart'
    as _i25;
import 'package:bunny_sync/global/localization/language_changer.dart' as _i22;
import 'package:bunny_sync/global/repos/delete_breeder_repo/delete_breeder_repo.dart'
    as _i18;
import 'package:bunny_sync/global/repos/repos.dart' as _i42;
import 'package:bunny_sync/global/repos/user_repo.dart' as _i31;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i14.CageCardsRepo>(() => _i14.HttpCageCardsRepo());
    gh.factory<_i15.CategoriesRepo>(() => _i15.HttpCategoriesRepo());
    gh.factory<_i16.CustomersRepo>(() => _i16.HttpCustomersRepo());
    gh.factory<_i17.DashboardCubit>(() => _i17.DashboardCubit());
    gh.factory<_i18.DeleteBreederRepo>(() => _i18.HttpDeleteBreederRepo());
    gh.singleton<_i19.DioClient>(() => _i19.DioClient());
    gh.factory<_i20.HealthRepo>(() => _i20.HttpHealthRepo());
    gh.factory<_i21.HomeRepo>(() => _i21.HttpHomeRepo());
    await gh.singletonAsync<_i22.LanguageChanger>(
      () {
        final i = _i22.LanguageChanger();
    ...
    await gh.singletonAsync<_i31.UserRepo>(
      () {
        final i = _i31.UserRepo();
        return i.init().then((_) => i);
      },
      preResolve: true,
    );
    ...
    gh.factory<_i32.AddAilmentCubit>(
        () => _i32.AddAilmentCubit(gh<_i3.AddAilmentRepo>()));
    gh.factory<_i33.AddBreederCubit>(
        () => _i33.AddBreederCubit(gh<_i4.AddBreederRepo>()));
    gh.factory<_i34.AddCageCubit>(
        () => _i34.AddCageCubit(gh<_i5.AddCageRepo>()));
    gh.factory<_i35.AddCategoryCubit>(
        () => _i35.AddCategoryCubit(gh<_i6.AddCategoryRepo>()));
    gh.factory<_i36.AddCustomerCubit>(
        () => _i36.AddCustomerCubit(gh<_i7.AddCustomerRepo>()));
    gh.factory<_i37.AddLitterCubit>(
        () => _i37.AddLitterCubit(gh<_i8.AddLitterRepo>()));
    gh.factory<_i38.AddNoteCubit>(
        () => _i38.AddNoteCubit(gh<_i9.AddNoteRepo>()));
    gh.factory<_i39.AddTaskCubit>(
        () => _i39.AddTaskCubit(gh<_i10.AddTaskRepo>()));
    gh.factory<_i40.AddTreatmentCubit>(
        () => _i40.AddTreatmentCubit(gh<_i11.AddTreatmentRepo>()));
    gh.singleton<_i41.AuthenticationBloc>(
        () => _i41.AuthenticationBloc(gh<_i42.UserRepo>()));
    gh.factoryParam<_i43.BreederDetailsCubit, _i44.BreederEntryModel, dynamic>((
      breeder,
      _,
    ) =>
        _i43.BreederDetailsCubit(
          gh<_i12.BreederDetailsRepo>(),
          breeder,
        ));
    gh.factory<_i45.BreedersCubit>(
        () => _i45.BreedersCubit(gh<_i13.BreedersRepo>()));
    gh.factory<_i46.CageCardsCubit>(
        () => _i46.CageCardsCubit(gh<_i14.CageCardsRepo>()));
    gh.factory<_i47.CategoriesCubit>(
        () => _i47.CategoriesCubit(gh<_i15.CategoriesRepo>()));
    gh.factory<_i48.CustomersCubit>(
        () => _i48.CustomersCubit(gh<_i16.CustomersRepo>()));
    gh.factory<_i49.DeleteBreederCubit>(
        () => _i49.DeleteBreederCubit(gh<_i18.DeleteBreederRepo>()));
    gh.factory<_i50.HealthCubit>(() => _i50.HealthCubit(gh<_i20.HealthRepo>()));
    gh.factory<_i51.HomeCubit>(() => _i51.HomeCubit(gh<_i21.HomeRepo>()));
    gh.factory<_i52.LitterDetailsCubit>(
        () => _i52.LitterDetailsCubit(gh<_i23.LitterDetailsRepo>()));
    gh.factory<_i53.LittersCubit>(
        () => _i53.LittersCubit(gh<_i24.LittersRepo>()));
    gh.factory<_i54.ProfileCubit>(
        () => _i54.ProfileCubit(gh<_i28.ProfileRepo>()));
    gh.factory<_i55.SignInCubit>(() => _i55.SignInCubit(
          gh<_i29.SignInRepo>(),
          gh<_i41.AuthenticationBloc>(),
        ));
    gh.factory<_i56.TasksCubit>(() => _i56.TasksCubit(gh<_i30.TasksRepo>()));
    return this;
  }
}
