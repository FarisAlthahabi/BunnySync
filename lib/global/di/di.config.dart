...
import 'package:bunny_sync/features/add_litter/repo/add_litter_repo.dart'
    as _i7;
import 'package:bunny_sync/features/add_note/cubit/add_note_cubit.dart' as _i34;
import 'package:bunny_sync/features/add_note/repo/add_note_repo.dart' as _i8;
import 'package:bunny_sync/features/add_task/cubit/add_task_cubit.dart' as _i35;
...
import 'package:bunny_sync/features/breeder_details/repo/breeder_details_repo.dart'
    as _i11;
import 'package:bunny_sync/features/breeders/cubit/breeders_cubit.dart' as _i41;
...
import 'package:bunny_sync/features/dashboard/cubit/dashboard_cubit.dart'
    as _i15;
import 'package:bunny_sync/features/health/cubit/health_cubit.dart' as _i45;
import 'package:bunny_sync/features/health/repo/health_repo.dart' as _i18;
import 'package:bunny_sync/features/home/cubit/home_cubit.dart' as _i46;
...
import 'package:bunny_sync/features/litter_details/repo/litter_details_repo.dart'
    as _i21;
import 'package:bunny_sync/features/litters/cubit/litters_cubit.dart' as _i48;
...
import 'package:bunny_sync/features/main_navigation/cubit/main_navigation_cubit.dart'
    as _i24;
import 'package:bunny_sync/features/sign_in/cubit/sign_in_cubit.dart' as _i49;
import 'package:bunny_sync/features/sign_in/repo/sign_in_repo.dart' as _i26;
import 'package:bunny_sync/features/tasks/cubit/tasks_cubit.dart' as _i50;
import 'package:bunny_sync/features/tasks/repo/tasks_repo.dart' as _i27;
...
import 'package:bunny_sync/global/blocs/permissions_cubit/permissions_cubit.dart'
    as _i25;
import 'package:bunny_sync/global/di/modules/app_module.dart' as _i51;
...
import 'package:bunny_sync/global/repos/delete_breeder_repo/delete_breeder_repo.dart'
    as _i16;
import 'package:bunny_sync/global/repos/repos.dart' as _i38;
import 'package:bunny_sync/global/repos/user_repo.dart' as _i28;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i26.SignInRepo>(() => _i26.HttpSignInRepo());
    gh.factory<_i27.TasksRepo>(() => _i27.HttpTasksRepo());
    await gh.singletonAsync<_i28.UserRepo>(
      () {
        final i = _i28.UserRepo();
        return i.init().then((_) => i);
      },
      preResolve: true,
    );
    ...
    gh.factory<_i29.AddAilmentCubit>(
        () => _i29.AddAilmentCubit(gh<_i3.AddAilmentRepo>()));
    gh.factory<_i30.AddBreederCubit>(
        () => _i30.AddBreederCubit(gh<_i4.AddBreederRepo>()));
    gh.factory<_i31.AddCategoryCubit>(
        () => _i31.AddCategoryCubit(gh<_i5.AddCategoryRepo>()));
    gh.factory<_i32.AddCustomerCubit>(
        () => _i32.AddCustomerCubit(gh<_i6.AddCustomerRepo>()));
    gh.factory<_i33.AddLitterCubit>(
        () => _i33.AddLitterCubit(gh<_i7.AddLitterRepo>()));
    gh.factory<_i34.AddNoteCubit>(
        () => _i34.AddNoteCubit(gh<_i8.AddNoteRepo>()));
    gh.factory<_i35.AddTaskCubit>(
        () => _i35.AddTaskCubit(gh<_i9.AddTaskRepo>()));
    gh.factory<_i36.AddTreatmentCubit>(
        () => _i36.AddTreatmentCubit(gh<_i10.AddTreatmentRepo>()));
    gh.singleton<_i37.AuthenticationBloc>(
        () => _i37.AuthenticationBloc(gh<_i38.UserRepo>()));
    gh.factoryParam<_i39.BreederDetailsCubit, _i40.BreederEntryModel, dynamic>((
      breeder,
      _,
    ) =>
        _i39.BreederDetailsCubit(
          gh<_i11.BreederDetailsRepo>(),
          breeder,
        ));
    gh.factory<_i41.BreedersCubit>(
        () => _i41.BreedersCubit(gh<_i12.BreedersRepo>()));
    gh.factory<_i42.CategoriesCubit>(
        () => _i42.CategoriesCubit(gh<_i13.CategoriesRepo>()));
    gh.factory<_i43.CustomersCubit>(
        () => _i43.CustomersCubit(gh<_i14.CustomersRepo>()));
    gh.factory<_i44.DeleteBreederCubit>(
        () => _i44.DeleteBreederCubit(gh<_i16.DeleteBreederRepo>()));
    gh.factory<_i45.HealthCubit>(() => _i45.HealthCubit(gh<_i18.HealthRepo>()));
    gh.factory<_i46.HomeCubit>(() => _i46.HomeCubit(gh<_i19.HomeRepo>()));
    gh.factory<_i47.LitterDetailsCubit>(
        () => _i47.LitterDetailsCubit(gh<_i21.LitterDetailsRepo>()));
    gh.factory<_i48.LittersCubit>(
        () => _i48.LittersCubit(gh<_i22.LittersRepo>()));
    gh.factory<_i49.SignInCubit>(() => _i49.SignInCubit(
          gh<_i26.SignInRepo>(),
          gh<_i37.AuthenticationBloc>(),
        ));
    gh.factory<_i50.TasksCubit>(() => _i50.TasksCubit(gh<_i27.TasksRepo>()));
    return this;
  }
}
