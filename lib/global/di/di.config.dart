...
import 'package:bunny_sync/features/add_litter/repo/add_litter_repo.dart'
    as _i6;
import 'package:bunny_sync/features/add_note/cubit/add_note_cubit.dart' as _i30;
...
import 'package:bunny_sync/features/breeder_details/repo/breeder_details_repo.dart'
    as _i9;
import 'package:bunny_sync/features/breeders/cubit/breeders_cubit.dart' as _i36;
...
import 'package:bunny_sync/features/dashboard/cubit/dashboard_cubit.dart'
    as _i12;
import 'package:bunny_sync/features/health/cubit/health_cubit.dart' as _i39;
import 'package:bunny_sync/features/health/repo/health_repo.dart' as _i15;
import 'package:bunny_sync/features/home/cubit/home_cubit.dart' as _i40;
...
import 'package:bunny_sync/features/litter_details/repo/litter_details_repo.dart'
    as _i18;
import 'package:bunny_sync/features/litters/cubit/litters_cubit.dart' as _i42;
...
import 'package:bunny_sync/features/main_navigation/cubit/main_navigation_cubit.dart'
    as _i21;
import 'package:bunny_sync/features/profile/cubit/profile_cubit.dart' as _i43;
import 'package:bunny_sync/features/profile/repo/profile_repo.dart' as _i23;
import 'package:bunny_sync/features/sign_in/cubit/sign_in_cubit.dart' as _i44;
...
import 'package:bunny_sync/global/blocs/permissions_cubit/permissions_cubit.dart'
    as _i22;
import 'package:bunny_sync/global/di/modules/app_module.dart' as _i45;
...
import 'package:bunny_sync/global/repos/delete_breeder_repo/delete_breeder_repo.dart'
    as _i13;
import 'package:bunny_sync/global/repos/repos.dart' as _i33;
import 'package:bunny_sync/global/repos/user_repo.dart' as _i25;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i23.ProfileRepo>(() => _i23.HttpProfileRepo());
    gh.factory<_i24.SignInRepo>(() => _i24.HttpSignInRepo());
    await gh.singletonAsync<_i25.UserRepo>(
      () {
        final i = _i25.UserRepo();
        return i.init().then((_) => i);
      },
      preResolve: true,
    );
    ...
    gh.factory<_i26.AddAilmentCubit>(
        () => _i26.AddAilmentCubit(gh<_i3.AddAilmentRepo>()));
    gh.factory<_i27.AddBreederCubit>(
        () => _i27.AddBreederCubit(gh<_i4.AddBreederRepo>()));
    gh.factory<_i28.AddCategoryCubit>(
        () => _i28.AddCategoryCubit(gh<_i5.AddCategoryRepo>()));
    gh.factory<_i29.AddLitterCubit>(
        () => _i29.AddLitterCubit(gh<_i6.AddLitterRepo>()));
    gh.factory<_i30.AddNoteCubit>(
        () => _i30.AddNoteCubit(gh<_i7.AddNoteRepo>()));
    gh.factory<_i31.AddTreatmentCubit>(
        () => _i31.AddTreatmentCubit(gh<_i8.AddTreatmentRepo>()));
    gh.singleton<_i32.AuthenticationBloc>(
        () => _i32.AuthenticationBloc(gh<_i33.UserRepo>()));
    gh.factoryParam<_i34.BreederDetailsCubit, _i35.BreederEntryModel, dynamic>((
      breeder,
      _,
    ) =>
        _i34.BreederDetailsCubit(
          gh<_i9.BreederDetailsRepo>(),
          breeder,
        ));
    gh.factory<_i36.BreedersCubit>(
        () => _i36.BreedersCubit(gh<_i10.BreedersRepo>()));
    gh.factory<_i37.CategoriesCubit>(
        () => _i37.CategoriesCubit(gh<_i11.CategoriesRepo>()));
    gh.factory<_i38.DeleteBreederCubit>(
        () => _i38.DeleteBreederCubit(gh<_i13.DeleteBreederRepo>()));
    gh.factory<_i39.HealthCubit>(() => _i39.HealthCubit(gh<_i15.HealthRepo>()));
    gh.factory<_i40.HomeCubit>(() => _i40.HomeCubit(gh<_i16.HomeRepo>()));
    gh.factory<_i41.LitterDetailsCubit>(
        () => _i41.LitterDetailsCubit(gh<_i18.LitterDetailsRepo>()));
    gh.factory<_i42.LittersCubit>(
        () => _i42.LittersCubit(gh<_i19.LittersRepo>()));
    gh.factory<_i43.ProfileCubit>(
        () => _i43.ProfileCubit(gh<_i23.ProfileRepo>()));
    gh.factory<_i44.SignInCubit>(() => _i44.SignInCubit(
          gh<_i24.SignInRepo>(),
          gh<_i32.AuthenticationBloc>(),
        ));
    return this;
  }
}
