...
/// generated route for
/// [AddBreederView]
class AddBreederRoute extends PageRouteInfo<void> {
  const AddBreederRoute({List<PageRouteInfo>? children})
      : super(
...
class BreederDetailsRouteArgs {
  ...
  @override
  String toString() {
    return 'BreederDetailsRouteArgs{key: $key, breederId: $breederId}';
  }
}
